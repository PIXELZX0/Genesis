...
function expectLoaderCall(overrides: Record<string, unknown>) {
  expect(loadGenesisPluginsMock).toHaveBeenCalledWith(expect.objectContaining(overrides));
}
...
describe("resolvePluginTools optional tools", () => {
  ...
  beforeEach(() => {
    ...
    resolveRuntimePluginRegistryMock.mockImplementation((params) => loadGenesisPluginsMock(params));
  ...
  it.each([
    {
      ...
      expectedLoaderCall: {
        env: { GENESIS_HOME: "/srv/genesis-home" },
      },
    },
    {
