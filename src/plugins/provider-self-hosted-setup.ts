...
export function applyProviderDefaultModel(cfg: GenesisConfig, modelRef: string): GenesisConfig {
...
function buildOpenAICompatibleSelfHostedProviderConfig(params: {
  ...
  contextWindow?: number;
  maxTokens?: number;
}): { config: GenesisConfig; modelId: string; modelRef: string; profileId: string } {
