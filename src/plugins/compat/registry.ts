...
export const PLUGIN_COMPAT_RECORDS = [
  ...
  },
  {
    ...
    deprecated: "2026-04-24",
    warningStarts: "2026-04-24",
    replacement: "focused `genesis/plugin-sdk/<subpath>` imports",
    docsPath: "/plugins/sdk-migration",
    surfaces: ["genesis/plugin-sdk", "genesis/plugin-sdk/compat"],
    diagnostics: ["GENESIS_PLUGIN_SDK_COMPAT_DEPRECATED"],
    tests: [
  ...
  },
  {
    ...
    surfaces: ["genesis.plugin.json providerAuthEnvVars", "provider setup"],
  ...
  },
  {
    ...
    docsPath: "/plugins/manifest",
    surfaces: ["genesis.plugin.json channelEnvVars", "channel setup"],
    diagnostics: ["manifest compatibility diagnostic"],
    tests: [
  ...
  },
  {
    ...
    deprecated: "2026-04-25",
    warningStarts: "2026-04-25",
    replacement: "`genesis/plugin-sdk/agent-runtime`",
    docsPath: "/plugins/sdk-agent-harness",
    surfaces: ["genesis/plugin-sdk/agent-harness", "genesis/plugin-sdk/agent-harness-runtime"],
