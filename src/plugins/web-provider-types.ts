...
export type WebSearchProviderPlugin = {
  ...
  getConfiguredCredentialValue?: (config?: GenesisConfig) => unknown;
  setConfiguredCredentialValue?: (configTarget: GenesisConfig, value: unknown) => void;
  applySelectionConfig?: (config: GenesisConfig) => GenesisConfig;
  runSetup?: (ctx: WebSearchProviderSetupContext) => GenesisConfig | Promise<GenesisConfig>;
