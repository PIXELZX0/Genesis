...
import type { GenesisPluginToolContext } from "../tool-types.js";
...
export type BoundTaskFlowRuntime = {
  ...
  cancel: (params: { flowId: string; cfg: GenesisConfig }) => Promise<BoundTaskFlowCancelResult>;
  runTask: (params: {
    flowId: string;
    runtime: TaskRuntime;
    sourceId?: string;
...
export type PluginRuntimeTaskFlow = {
  ...
  fromToolContext: (
    ctx: Pick<GenesisPluginToolContext, "sessionKey" | "deliveryContext">,
  ) => BoundTaskFlowRuntime;
};
