...
import { normalizeGenesisVersionBase } from "../config/version.js";
...
function resolveReportedPluginVersion(
  ...
  return (
    normalizeGenesisVersionBase(resolveCompatibilityHostVersion(env)) ??
    normalizeGenesisVersionBase(plugin.version) ??
    plugin.version
  );
}
