...
function resolveAcpStreamCoalesceIdleMs(cfg: GenesisConfig): number {
...
function resolveAcpStreamMaxChunkChars(cfg: GenesisConfig): number {
...
export function resolveAcpProjectionSettings(cfg: GenesisConfig): AcpProjectionSettings {
