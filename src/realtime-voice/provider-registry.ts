...
function resolveRealtimeVoiceProviderEntries(cfg?: GenesisConfig): RealtimeVoiceProviderPlugin[] {
...
export function listRealtimeVoiceProviders(cfg?: GenesisConfig): RealtimeVoiceProviderPlugin[] {
