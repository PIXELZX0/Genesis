...
describe("skills-cli", () => {
  describe("formatSkillsList", () => {
    it("formats empty skills list", () => {
      ...
      expect(output).toContain("genesis skills search");
    });
  ...
  describe("formatSkillInfo", () => {
    it("returns not found message for unknown skill", () => {
      ...
      expect(output).toContain("genesis skills install");
    });
    ...
    it("shows API key storage guidance for the active config path", () => {
      ...
      expect(output).toContain("GENESIS_CONFIG_PATH");
      expect(output).toContain("default: ~/.genesis/genesis.json");
  ...
  describe("formatSkillsCheck", () => {
    it("shows summary of skill status", () => {
      ...
      expect(output).toContain("genesis skills update");
    });
