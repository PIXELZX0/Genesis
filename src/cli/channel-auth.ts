...
function isConfiguredAuthPlugin(plugin: ChannelPlugin, cfg: GenesisConfig): boolean {
  const key = plugin.id;
...
function resolveConfiguredAuthChannelInput(cfg: GenesisConfig, mode: ChannelAuthMode): string {
