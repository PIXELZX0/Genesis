    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ...
          ["genesis security audit --deep --token <token>", "Use explicit token for deep probe."],
          [
        ...
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink("/cli/security", "genesis.pixelzx.com/docs/cli/security")}\n`,
    );
