...
const DEFAULT_SANDBOX_SSH_WORKSPACE_ROOT = "/tmp/genesis-sandboxes";
...
export function resolveSandboxConfigForAgent(cfg?: GenesisConfig, agentId?: string): SandboxConfig {
