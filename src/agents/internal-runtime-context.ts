export const INTERNAL_RUNTIME_CONTEXT_BEGIN = "<<<BEGIN_GENESIS_INTERNAL_CONTEXT>>>";
export const INTERNAL_RUNTIME_CONTEXT_END = "<<<END_GENESIS_INTERNAL_CONTEXT>>>";

const ESCAPED_INTERNAL_RUNTIME_CONTEXT_BEGIN = "[[GENESIS_INTERNAL_CONTEXT_BEGIN]]";
const ESCAPED_INTERNAL_RUNTIME_CONTEXT_END = "[[GENESIS_INTERNAL_CONTEXT_END]]";
