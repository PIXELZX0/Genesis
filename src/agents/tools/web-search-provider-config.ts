...
type ConfiguredWebSearchProvider = NonNullable<
  NonNullable<NonNullable<GenesisConfig["tools"]>["web"]>["search"]
>["provider"];

export type WebSearchConfig = NonNullable<GenesisConfig["tools"]>["web"] extends infer Web
...
export function resolveSearchConfig(cfg?: GenesisConfig): WebSearchConfig {
