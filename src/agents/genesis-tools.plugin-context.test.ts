...
import { resolveGenesisPluginToolInputs } from "./genesis-tools.plugin-context.js";
import { applyPluginToolDeliveryDefaults } from "./plugin-tool-delivery-defaults.js";
import type { AnyAgentTool } from "./tools/common.js";

describe("genesis plugin tool context", () => {
  it("forwards trusted requester sender identity", () => {
    const result = resolveGenesisPluginToolInputs({
      options: {
        config: {} as never,
