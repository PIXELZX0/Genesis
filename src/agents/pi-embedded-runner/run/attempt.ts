...
import { createEmbeddedAttemptTools, prepareEmbeddedAttemptToolContext } from "./attempt-tools.js";
import {
...
export { applyEmbeddedAttemptToolsAllow } from "./attempt-tools.js";
...
export async function runEmbeddedAttempt(
  ...
  try {
    ...
    const toolsRaw = createEmbeddedAttemptTools({
      attempt: params,
      context: toolContext,
    ...
    try {
      ...
      // DefaultResourceLoader.reload() rehydrates settings from disk and can drop Genesis
      ...
      // exact Genesis-managed registrations so custom tools survive startup and
      ...
      try {
        ...
        // double-compaction. See: https://github.com/PIXELZX0/Genesis/issues/9282
      ...
      // See: https://github.com/PIXELZX0/Genesis/issues/8643
