...
export const FULL_BOOTSTRAP_COMPLETED_CUSTOM_TYPE = "genesis:bootstrap-context:full";
...
export function resolveContextInjectionMode(config?: GenesisConfig): AgentContextInjection {
