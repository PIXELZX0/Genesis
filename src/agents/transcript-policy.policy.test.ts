...
function createProviderRuntimeSmokeContext(): {
  ...
  delete env.GENESIS_BUNDLED_PLUGINS_DIR;
  delete env.GENESIS_SKIP_PROVIDERS;
  delete env.GENESIS_SKIP_CHANNELS;
  delete env.GENESIS_SKIP_CRON;
  delete env.GENESIS_TEST_MINIMAL_GATEWAY;
  return {
    config: {},
    env,
