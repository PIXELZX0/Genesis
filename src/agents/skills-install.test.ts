...
import { resolveGenesisMetadata, resolveSkillInvocationPolicy } from "./skills/frontmatter.js";
...
const workspaceSuite = createFixtureSuite("genesis-skills-install-");
