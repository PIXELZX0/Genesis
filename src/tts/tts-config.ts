...
export function resolveConfiguredTtsMode(cfg: GenesisConfig): TtsMode {
...
export function shouldAttemptTtsPayload(params: { cfg: GenesisConfig; ttsAuto?: string }): boolean {
