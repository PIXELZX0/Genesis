...
export function collectLoggingFindings(cfg: GenesisConfig): SecurityAuditFinding[] {
...
export function collectElevatedFindings(cfg: GenesisConfig): SecurityAuditFinding[] {
  const findings: SecurityAuditFinding[] = [];
...
export function collectExecRuntimeFindings(cfg: GenesisConfig): SecurityAuditFinding[] {
  const findings: SecurityAuditFinding[] = [];
...
function collectOpenExecSurfacePaths(cfg: GenesisConfig): string[] {
