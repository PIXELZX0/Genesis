...
export type ChannelSetupWizardEnvShortcut = {
  ...
  isAvailable: (params: { cfg: GenesisConfig; accountId: string }) => boolean;
  apply: (params: {
    cfg: GenesisConfig;
    accountId: string;
...
export type ChannelSetupWizardCredential = {
  ...
  keepPrompt: string;
  inputPrompt: string;
  allowEnv?: (params: { cfg: GenesisConfig; accountId: string }) => boolean;
  inspect: (params: { cfg: GenesisConfig; accountId: string }) => ChannelSetupWizardCredentialState;
  shouldPrompt?: (params: {
    cfg: GenesisConfig;
    accountId: string;
    credentialValues: ChannelSetupWizardCredentialValues;
...
export type ChannelSetupWizardGroupAccess = {
  ...
  currentPolicy: (params: { cfg: GenesisConfig; accountId: string }) => ChannelAccessPolicy;
  currentEntries: (params: { cfg: GenesisConfig; accountId: string }) => string[];
  updatePrompt: (params: { cfg: GenesisConfig; accountId: string }) => boolean;
  setPolicy: (params: {
    cfg: GenesisConfig;
    accountId: string;
...
export type ChannelOnboardingPostWriteHook = {
  channel: ChannelId;
  accountId: string;
  run: (ctx: { cfg: GenesisConfig; runtime: RuntimeEnv }) => Promise<void> | void;
};
...
export type ChannelSetupDmPolicy = {
  ...
  getCurrent: (cfg: GenesisConfig, accountId?: string) => DmPolicy;
  setPolicy: (cfg: GenesisConfig, policy: DmPolicy, accountId?: string) => GenesisConfig;
