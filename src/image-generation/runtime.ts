...
function buildNoImageGenerationModelConfiguredMessage(cfg: GenesisConfig): string {
...
export function listRuntimeImageGenerationProviders(params?: { config?: GenesisConfig }) {
