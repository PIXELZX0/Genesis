...
export function attachGenesisTranscriptMeta(
  message: unknown,
  ...
  const existing =
    record.__genesis && typeof record.__genesis === "object" && !Array.isArray(record.__genesis)
      ? (record.__genesis as Record<string, unknown>)
      : {};
  return {
    ...record,
    __genesis: {
      ...
      const model =
        typeof message.model === "string"
          ...
          : typeof parsed.model === "string"
            ? parsed.model.trim()
            : undefined;
      const isDeliveryMirror = modelProvider === "genesis" && model === "delivery-mirror";
