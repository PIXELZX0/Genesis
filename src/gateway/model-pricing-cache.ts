...
export function collectConfiguredModelPricingRefs(config: GenesisConfig): ModelRef[] {
...
function scheduleRefresh(params: { config: GenesisConfig; fetchImpl: typeof fetch }): void {
  clearRefreshTimer();
