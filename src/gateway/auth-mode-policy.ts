...
export function hasAmbiguousGatewayAuthModeConfig(cfg: GenesisConfig): boolean {
...
export function assertExplicitGatewayAuthModeWhenBothConfigured(cfg: GenesisConfig): void {
