...
const previousTestHandshakeTimeout = process.env.GENESIS_TEST_HANDSHAKE_TIMEOUT_MS;
...
afterEach(() => {
  ...
  process.env.GENESIS_TEST_HANDSHAKE_TIMEOUT_MS = previousTestHandshakeTimeout;
});
