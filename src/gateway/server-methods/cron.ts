...
function listConfiguredAnnounceChannelIds(cfg: GenesisConfig): string[] {
...
function assertValidCronAnnounceDelivery(params: { cfg: GenesisConfig; delivery?: CronDelivery }) {
...
function assertValidCronCreateDelivery(cfg: GenesisConfig, jobCreate: CronJobCreate) {
