...
import {
  ...
  type ContactsSaveResult,
  ContactsSaveResultSchema,
  type ContactsDeleteParams,
  ContactsDeleteParamsSchema,
  type ContactsDeleteResult,
  ContactsDeleteResultSchema,
  ...
  FilesWriteParamsSchema,
  type FilesWriteResult,
  FilesWriteResultSchema,
  type FilesDeleteParams,
  FilesDeleteParamsSchema,
  type FilesRenameParams,
  FilesRenameParamsSchema,
  type FilesMkdirParams,
  FilesMkdirParamsSchema,
  type FilesOkResult,
  FilesOkResultSchema,
  ...
  type ChannelsDeleteParams,
  ChannelsDeleteParamsSchema,
  ...
  type ConfigBackupRestoreParams,
  ConfigBackupRestoreParamsSchema,
  type ConfigBackupsParams,
  ConfigBackupsParamsSchema,
...
export const validateFilesListParams = ajv.compile<FilesListParams>(FilesListParamsSchema);
export const validateFilesReadParams = ajv.compile<FilesReadParams>(FilesReadParamsSchema);
export const validateFilesWriteParams = ajv.compile<FilesWriteParams>(FilesWriteParamsSchema);
export const validateFilesDeleteParams = ajv.compile<FilesDeleteParams>(FilesDeleteParamsSchema);
export const validateFilesRenameParams = ajv.compile<FilesRenameParams>(FilesRenameParamsSchema);
export const validateFilesMkdirParams = ajv.compile<FilesMkdirParams>(FilesMkdirParamsSchema);
...
export const validateConfigBackupsParams =
  ajv.compile<ConfigBackupsParams>(ConfigBackupsParamsSchema);
export const validateConfigBackupRestoreParams = ajv.compile<ConfigBackupRestoreParams>(
  ConfigBackupRestoreParamsSchema,
);
...
export const validateChannelsDeleteParams = ajv.compile<ChannelsDeleteParams>(
  ChannelsDeleteParamsSchema,
);
