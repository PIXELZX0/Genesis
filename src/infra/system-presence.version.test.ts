  ...
  return withEnvAsync(
    {
      ...
      GENESIS_SERVICE_VERSION: undefined,
...
describe("system-presence version fallback", () => {
  ...
  it("uses runtime VERSION when GENESIS_VERSION is not set", async () => {
  ...
  it("prefers GENESIS_VERSION over runtime VERSION", async () => {
    await expectSelfVersion(
      {
  ...
  it("still prefers runtime VERSION over GENESIS_SERVICE_VERSION when GENESIS_VERSION is blank", async () => {
    await expectSelfVersion(
      {
        GENESIS_VERSION: " ",
        GENESIS_SERVICE_VERSION: "2.4.6-service",
  ...
  it("uses runtime VERSION when GENESIS_VERSION and GENESIS_SERVICE_VERSION are blank", async () => {
    await expectSelfVersion(
      {
        GENESIS_VERSION: " ",
        GENESIS_SERVICE_VERSION: "\t",
