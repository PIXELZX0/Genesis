...
vi.mock("./genesis-root.js", async () => {
  const actual = await vi.importActual<typeof import("./genesis-root.js")>("./genesis-root.js");
  return {
    ...actual,
...
describe("update-startup", () => {
  const suiteRootTracker = createSuiteTempRootTracker({ prefix: "genesis-update-check-suite-" });
  let tempDir: string;
