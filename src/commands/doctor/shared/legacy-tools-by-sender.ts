...
export function scanLegacyToolsBySenderKeys(cfg: GenesisConfig): LegacyToolsBySenderKeyHit[] {
...
export function maybeRepairLegacyToolsBySenderKeys(cfg: GenesisConfig): {
