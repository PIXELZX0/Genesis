...
export function collectMissingDefaultAccountBindingWarnings(cfg: GenesisConfig): string[] {
...
export function collectMissingExplicitDefaultAccountWarnings(cfg: GenesisConfig): string[] {
  const warnings: string[] = [];
