...
function hasChannels(cfg: GenesisConfig): boolean {
  return hasRecord(cfg.channels);
}

function hasPlugins(cfg: GenesisConfig): boolean {
  return hasRecord(cfg.plugins);
}

function hasPluginLoadPaths(cfg: GenesisConfig): boolean {
...
function hasExplicitChannelPluginBlockerConfig(cfg: GenesisConfig): boolean {
...
function hasConfiguredSafeBins(cfg: GenesisConfig): boolean {
