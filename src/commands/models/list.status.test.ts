...
const mocks = vi.hoisted(() => {
  ...
  return {
    ...
    resolveAgentWorkspaceDir: vi.fn().mockReturnValue("/tmp/genesis-agent/workspace"),
    ...
    createConfigIO: vi.fn().mockReturnValue({
      configPath: "/tmp/genesis-dev/genesis.json",
    }),
...
describe("modelsStatusCommand auth overview", () => {
  it("includes masked auth sources in JSON output", async () => {
    ...
    expect(payload.configPath).toBe("/tmp/genesis-dev/genesis.json");
