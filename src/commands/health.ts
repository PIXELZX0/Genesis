...
async function inspectHealthAccount(plugin: ChannelPlugin, cfg: GenesisConfig, accountId: string) {
  return (
...
async function readBestEffortHealthConfig(): Promise<GenesisConfig> {
