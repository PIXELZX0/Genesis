...
let originalGenesisTestConsole: string | undefined;
...
beforeEach(() => {
  ...
  originalGenesisTestConsole = process.env.GENESIS_TEST_CONSOLE;
  process.env.GENESIS_TEST_CONSOLE = "1";
...
afterEach(() => {
  ...
  if (originalGenesisTestConsole === undefined) {
    delete process.env.GENESIS_TEST_CONSOLE;
  } else {
    process.env.GENESIS_TEST_CONSOLE = originalGenesisTestConsole;
  }
