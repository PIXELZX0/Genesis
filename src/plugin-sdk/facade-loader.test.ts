...
const FACADE_LOADER_GLOBAL = "__genesisTestLoadBundledPluginPublicSurfaceModuleSync";
...
describe("plugin-sdk facade loader", () => {
  it("honors bundled plugin dir overrides outside the package root", () => {
    const overrideA = createBundledPluginDir("genesis-facade-loader-a-", "override-a");
    const overrideB = createBundledPluginDir("genesis-facade-loader-b-", "override-b");
  ...
  it("shares loaded facade ids with facade-runtime", () => {
    const dir = createBundledPluginDir("genesis-facade-loader-ids-", "identity-check");
  ...
  it("uses native Jiti import for Windows dist facade loads", () => {
    const dir = createTempDirSync("genesis-facade-loader-windows-dist-");
    ...
    process.env.GENESIS_BUNDLED_PLUGINS_DIR = bundledPluginsDir;
  ...
  it("breaks circular facade re-entry during module evaluation", () => {
    const dir = createCircularPluginDir("genesis-facade-loader-circular-");
    process.env.GENESIS_BUNDLED_PLUGINS_DIR = dir;
  ...
  it("clears the cache on load failure so retries re-execute", () => {
    const dir = createThrowingPluginDir("genesis-facade-loader-throw-");
    process.env.GENESIS_BUNDLED_PLUGINS_DIR = dir;
