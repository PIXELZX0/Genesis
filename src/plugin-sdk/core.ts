...
import type { GenesisPluginApi } from "../plugins/types.js";
...
export type { GenesisPluginToolContext, GenesisPluginToolFactory } from "../plugins/types.js";
export type {
...
type ChatChannelThreadingReplyModeOptions<TResolvedAccount> =
  ...
  | {
      scopedAccountReplyToMode: {
        resolveAccount: (cfg: GenesisConfig, accountId?: string | null) => TResolvedAccount;
        resolveReplyToMode: (
