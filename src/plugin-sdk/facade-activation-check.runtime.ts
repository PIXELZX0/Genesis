...
const EMPTY_FACADE_BOUNDARY_CONFIG: GenesisConfig = {};

let cachedBoundaryRawConfig: GenesisConfig | undefined;
...
function readBundledPluginManifestRecordFromDir(params: {
  ...
  const manifestPath = path.join(params.pluginsRoot, params.resolvedDirName, "genesis.plugin.json");
