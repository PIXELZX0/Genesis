...
import type { ModelProviderConfig, GenesisConfig } from "../config/types.js";
import { loadBundledPluginPublicSurfaceModuleSync } from "./facade-loader.js";

type FacadeModule = {
  applyOpenrouterConfig: (cfg: GenesisConfig) => GenesisConfig;
  applyOpenrouterProviderConfig: (cfg: GenesisConfig) => GenesisConfig;
