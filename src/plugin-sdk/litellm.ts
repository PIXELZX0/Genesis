...
import type { ModelDefinitionConfig, GenesisConfig } from "../config/types.js";
import { loadBundledPluginPublicSurfaceModuleSync } from "./facade-loader.js";

type FacadeModule = {
  applyLitellmConfig: (cfg: GenesisConfig) => GenesisConfig;
  applyLitellmProviderConfig: (cfg: GenesisConfig) => GenesisConfig;
