...
export type { GenesisConfig, ModelApi, ModelDefinitionConfig, ModelProviderConfig };
export {
...
export type ProviderOnboardPresetAppliers<TArgs extends unknown[]> = {
  applyProviderConfig: (cfg: GenesisConfig, ...args: TArgs) => GenesisConfig;
  applyConfig: (cfg: GenesisConfig, ...args: TArgs) => GenesisConfig;
};
...
>(params: {
  ...
  applyPreset: (cfg: GenesisConfig, preset: TParams) => GenesisConfig;
  primaryModelRef: string;
...
export function applyAgentDefaultModelPrimary(cfg: GenesisConfig, primary: string): GenesisConfig {
