...
type ChannelConfigAccessorParams<Config extends GenesisConfig = GenesisConfig> = {
  cfg: Config;
  accountId?: string | null;
};
...
type MultiAccountChannelConfigAdapterParams<
  ...
  Config extends GenesisConfig = GenesisConfig,
> = {
  sectionKey: string;
...
export function adaptScopedAccountAccessor<Result, Config extends GenesisConfig = GenesisConfig>(
...
> {
  const base = {
    resolveAllowFrom({ cfg, accountId }: { cfg: GenesisConfig; accountId?: string | null }) {
...
function setTopLevelChannelEnabledInConfigSection<Config extends GenesisConfig>(params: {
  cfg: Config;
  sectionKey: string;
  enabled: boolean;
}): Config {
...
function removeTopLevelChannelConfigSection<Config extends GenesisConfig>(params: {
  cfg: Config;
  sectionKey: string;
}): Config {
...
function clearTopLevelChannelConfigFields<Config extends GenesisConfig>(params: {
  cfg: Config;
  sectionKey: string;
  clearBaseFields: string[];
}): Config {
