...
export type TtsRuntimeFacade = {
  _test: TtsTestFacade;
  buildTtsSystemPromptHint: (cfg: GenesisConfig) => string | undefined;
  ...
  resolveTtsConfig: (cfg: GenesisConfig) => ResolvedTtsConfig;
  resolveTtsPrefsPath: (config: ResolvedTtsConfig) => string;
  resolveTtsProviderOrder: (primary: TtsProvider, cfg?: GenesisConfig) => TtsProvider[];
