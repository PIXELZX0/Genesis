...
export function applyConfigEnvVars(cfg: GenesisConfig, env: NodeJS.ProcessEnv = process.env): void {
  ...
  for (const [key, value] of Object.entries(entries)) {
    ...
    // (e.g. process.env.GENESIS_GATEWAY_TOKEN = "${VAULT_TOKEN}") which downstream auth
