...
export function createConfigWriteAuditRecordBase(params: {
  ...
  return {
    ...
    watchMode: params.env.GENESIS_WATCH_MODE === "1",
    watchSession: normalizeAuditLabel(params.env.GENESIS_WATCH_SESSION),
    watchCommand: normalizeAuditLabel(params.env.GENESIS_WATCH_COMMAND),
