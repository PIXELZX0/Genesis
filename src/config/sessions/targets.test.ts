...
function createCustomRootCfg(customRoot: string, defaultAgentId = "ops"): GenesisConfig {
  return {
    session: {
...
const discoveryResolvers = [
  {
    label: "async",
    resolve: async (cfg: GenesisConfig, env: NodeJS.ProcessEnv) =>
