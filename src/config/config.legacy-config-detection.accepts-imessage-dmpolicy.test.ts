...
function expectGenesisSchemaInvalidPreservesField(params: {
  config: unknown;
  ...
  const res = GenesisSchema.safeParse(params.config);
...
describe("legacy config detection", () => {
  ...
  it("rejects removed legacy provider sections", () => {
    expectGenesisSchemaInvalidPreservesField({
  ...
  it("preserves claude-cli auth profile mode during validation", () => {
    ...
    const res = GenesisSchema.safeParse(config);
