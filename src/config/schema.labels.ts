...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "browser.tor": "Browser Tor Routing",
  "browser.tor.enabled": "Browser Tor Enabled",
  "browser.tor.mode": "Browser Tor Mode",
  "browser.tor.routeMode": "Browser Tor Route Mode",
  "browser.tor.executablePath": "Browser Tor Executable Path",
  "browser.tor.socksHost": "Browser Tor SOCKS Host",
  "browser.tor.socksPort": "Browser Tor SOCKS Port",
  "browser.tor.dataDir": "Browser Tor Data Dir",
  "browser.tor.extraArgs": "Browser Tor Extra Args",
  ...
  "browser.profiles.*.tor": "Browser Profile Tor Routing",
  "browser.profiles.*.tor.enabled": "Browser Profile Tor Enabled",
  "browser.profiles.*.tor.mode": "Browser Profile Tor Mode",
  "browser.profiles.*.tor.routeMode": "Browser Profile Tor Route Mode",
  "browser.profiles.*.tor.executablePath": "Browser Profile Tor Executable Path",
  "browser.profiles.*.tor.socksHost": "Browser Profile Tor SOCKS Host",
  "browser.profiles.*.tor.socksPort": "Browser Profile Tor SOCKS Port",
  "browser.profiles.*.tor.dataDir": "Browser Profile Tor Data Dir",
  "browser.profiles.*.tor.extraArgs": "Browser Profile Tor Extra Args",
  ...
  "wallet.primaryAccount": "Primary Wallet Account",
  "wallet.networks": "Wallet Networks",
  "wallet.networks.btc": "Bitcoin Wallet Network",
  "wallet.networks.btc.enabled": "Bitcoin Wallet Enabled",
  "wallet.networks.btc.network": "Bitcoin Network",
  "wallet.networks.btc.esploraUrl": "Bitcoin Esplora URL",
  "wallet.networks.btc.feeRateSatPerVbyte": "Bitcoin Fee Rate",
  "wallet.networks.btc.derivationPath": "Bitcoin Derivation Path",
  "wallet.networks.evm": "EVM Wallet Network",
  "wallet.networks.evm.enabled": "EVM Wallet Enabled",
  "wallet.networks.evm.chainId": "EVM Chain ID",
  "wallet.networks.evm.name": "EVM Network Name",
  "wallet.networks.evm.rpcUrl": "EVM RPC URL",
  "wallet.networks.evm.currencySymbol": "EVM Currency Symbol",
  "wallet.networks.evm.derivationPath": "EVM Derivation Path",
  "wallet.networks.evm.explorerTxUrl": "EVM Explorer Transaction URL",
  "wallet.networks.evm.tokens": "EVM Token Watchlist",
  "wallet.networks.evm.tokens.*.enabled": "EVM Token Enabled",
  "wallet.networks.evm.tokens.*.address": "EVM Token Contract Address",
  "wallet.networks.evm.tokens.*.symbol": "EVM Token Symbol",
  "wallet.networks.evm.tokens.*.name": "EVM Token Name",
  "wallet.networks.evm.tokens.*.decimals": "EVM Token Decimals",
  "wallet.networks.evm.nfts": "EVM NFT Watchlist",
  "wallet.networks.evm.nfts.*.enabled": "EVM NFT Collection Enabled",
  "wallet.networks.evm.nfts.*.address": "EVM NFT Contract Address",
  "wallet.networks.evm.nfts.*.standard": "EVM NFT Standard",
  "wallet.networks.evm.nfts.*.name": "EVM NFT Collection Name",
  "wallet.networks.evm.nfts.*.symbol": "EVM NFT Symbol",
  "wallet.networks.evm.nfts.*.tokenIds": "EVM NFT Token IDs",
  "wallet.networks.evm.chains": "EVM Wallet Chains",
  "wallet.networks.evm.chains.*.enabled": "EVM Chain Enabled",
  "wallet.networks.evm.chains.*.chainId": "EVM Chain ID",
  "wallet.networks.evm.chains.*.name": "EVM Chain Name",
  "wallet.networks.evm.chains.*.rpcUrl": "EVM Chain RPC URL",
  "wallet.networks.evm.chains.*.currencySymbol": "EVM Chain Currency Symbol",
  "wallet.networks.evm.chains.*.explorerTxUrl": "EVM Chain Explorer Transaction URL",
  "wallet.networks.evm.chains.*.tokens": "EVM Token Watchlist",
  "wallet.networks.evm.chains.*.tokens.*.enabled": "EVM Token Enabled",
  "wallet.networks.evm.chains.*.tokens.*.address": "EVM Token Contract Address",
  "wallet.networks.evm.chains.*.tokens.*.symbol": "EVM Token Symbol",
  "wallet.networks.evm.chains.*.tokens.*.name": "EVM Token Name",
  "wallet.networks.evm.chains.*.tokens.*.decimals": "EVM Token Decimals",
  "wallet.networks.evm.chains.*.nfts": "EVM NFT Watchlist",
  "wallet.networks.evm.chains.*.nfts.*.enabled": "EVM NFT Collection Enabled",
  "wallet.networks.evm.chains.*.nfts.*.address": "EVM NFT Contract Address",
  "wallet.networks.evm.chains.*.nfts.*.standard": "EVM NFT Standard",
  "wallet.networks.evm.chains.*.nfts.*.name": "EVM NFT Collection Name",
  "wallet.networks.evm.chains.*.nfts.*.symbol": "EVM NFT Symbol",
  "wallet.networks.evm.chains.*.nfts.*.tokenIds": "EVM NFT Token IDs",
  "wallet.networks.sol": "Solana Wallet Network",
  "wallet.networks.sol.enabled": "Solana Wallet Enabled",
  "wallet.networks.sol.network": "Solana Network",
  "wallet.networks.sol.rpcUrl": "Solana RPC URL",
  "wallet.networks.sol.derivationPath": "Solana Derivation Path",
  "wallet.networks.sol.explorerTxUrl": "Solana Explorer Transaction URL",
  "wallet.networks.trx": "TRON Wallet Network",
  "wallet.networks.trx.enabled": "TRON Wallet Enabled",
  "wallet.networks.trx.fullHost": "TRON Full Host",
  "wallet.networks.trx.apiKey": "TRON API Key",
  "wallet.networks.trx.derivationPath": "TRON Derivation Path",
  "wallet.networks.trx.explorerTxUrl": "TRON Explorer Transaction URL",
  "wallet.networks.xmr": "Monero Wallet RPC",
  "wallet.networks.xmr.enabled": "Monero Wallet Enabled",
  "wallet.networks.xmr.walletRpcUrl": "Monero Wallet RPC URL",
  "wallet.networks.xmr.username": "Monero Wallet RPC Username",
  "wallet.networks.xmr.password": "Monero Wallet RPC Password",
  "wallet.networks.xmr.accountIndex": "Monero Account Index",
  "wallet.networks.xmr.addressIndex": "Monero Address Index",
  "wallet.networks.xmr.explorerTxUrl": "Monero Explorer Transaction URL",
  "wallet.networks.lndhub": "Bitcoin Lightning (LndHub) Wallet",
  "wallet.networks.lndhub.enabled": "LndHub Wallet Enabled",
  "wallet.networks.lndhub.baseUrl": "LndHub Base URL",
  "wallet.networks.lndhub.login": "LndHub Login",
  "wallet.networks.lndhub.password": "LndHub Password",
  "wallet.networks.lndhub.lightningAddress": "LndHub Lightning Address",
  "wallet.networks.lndhub.explorerTxUrl": "LndHub Explorer Transaction URL",
  "wallet.spending": "Wallet Spending",
  "wallet.spending.enabled": "Wallet Spending Enabled",
  "wallet.spending.requireAllowEnv": "Require Spending Env Guard",
  "wallet.spending.maxNativeAmount": "Max Native Amount per Send",
  "wallet.browser": "Browser Web3 Provider",
  "wallet.browser.enabled": "Browser Web3 Provider Enabled",
  "wallet.browser.allowedOrigins": "Browser Web3 Allowed Origins",
  ...
  "tools.advisor.timeoutSeconds": "Advisor Timeout (s)",
  approvals: "Approvals",
  ...
  "mcp.metadataFetch": "MCP Metadata Fetch",
  "mcp.metadataFetch.allowedHosts": "Allowed Metadata Hosts",
  ui: "UI",
  ...
  "session.contacts.enabled": "Enable Contacts",
  "session.contacts.unifySessions": "Unify Contact DM Sessions",
