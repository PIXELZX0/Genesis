...
export function applyTalkConfigNormalization(config: GenesisConfig): GenesisConfig {
...
function hasAnthropicDefaultSignal(cfg: GenesisConfig, env: NodeJS.ProcessEnv): boolean {
