...
const FIELD_PLACEHOLDERS: Record<string, string> = {
  ...
  "wallet.networks.btc.esploraUrl": "https://blockstream.info/api",
  "wallet.networks.evm.rpcUrl": "https://ethereum-rpc.publicnode.com",
  "wallet.networks.evm.tokens.*.address": "0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48",
  "wallet.networks.evm.nfts.*.address": "0x0000000000000000000000000000000000000000",
  "wallet.networks.evm.chains.*.rpcUrl": "https://mainnet.base.org",
  "wallet.networks.evm.chains.*.tokens.*.address": "0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48",
  "wallet.networks.evm.chains.*.nfts.*.address": "0x0000000000000000000000000000000000000000",
  "wallet.networks.sol.rpcUrl": "https://api.mainnet-beta.solana.com",
  "wallet.networks.trx.fullHost": "https://api.trongrid.io",
  "wallet.networks.xmr.walletRpcUrl": "http://127.0.0.1:18083/json_rpc",
