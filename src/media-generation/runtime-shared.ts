...
type CapabilityProviderCandidate = {
  ...
  isConfigured?: (ctx: { cfg?: GenesisConfig; agentDir?: string }) => boolean;
};
...
function resolveCurrentDefaultProviderId(cfg?: GenesisConfig): string {
...
function resolveAutoCapabilityFallbackRefs(params: {
  cfg: GenesisConfig;
  agentDir?: string;
  listProviders: (cfg?: GenesisConfig) => CapabilityProviderCandidate[];
}): string[] {
