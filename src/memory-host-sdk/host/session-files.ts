...
function isDreamingNarrativeBootstrapRecord(record: unknown): boolean {
  ...
  if (
    ...
    candidate.customType !== "genesis:bootstrap-context:full" ||
    !candidate.data ||
...
/**
 * Strip Genesis-injected inbound metadata envelopes from a raw text block.
 *
 ...
 * impossible.
 *
 * See: https://github.com/PIXELZX0/Genesis/issues/63921
 */
