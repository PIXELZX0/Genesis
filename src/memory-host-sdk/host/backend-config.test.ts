...
function resolveCollectionNamesForAgent(cfg: GenesisConfig, agentId: string): Set<string> {
  return new Set(
...
function resolveCustomCollectionPathsForAgent(cfg: GenesisConfig, agentId: string): string[] {
