...
export function listAuthProfileStorePaths(config: GenesisConfig, stateDir: string): string[] {
...
export function collectAuthStorePaths(config: GenesisConfig, stateDir: string): string[] {
