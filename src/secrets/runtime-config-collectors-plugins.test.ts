...
function makeContext(sourceConfig: GenesisConfig): ResolverContext {
...
function collectAcpxConfigAssignments(config: GenesisConfig): ResolverContext {
...
function expectInactiveAcpxConfig(config: GenesisConfig): void {
