...
function resolveResolutionLimits(config: GenesisConfig): ResolutionLimits {
...
function resolveConfiguredProvider(ref: SecretRef, config: GenesisConfig): SecretProviderConfig {
