...
export function isAcpEnabledByPolicy(cfg: GenesisConfig): boolean {
  return cfg.acp?.enabled !== false;
}

export function resolveAcpDispatchPolicyState(cfg: GenesisConfig): AcpDispatchPolicyState {
...
export function isAcpDispatchEnabledByPolicy(cfg: GenesisConfig): boolean {
  return resolveAcpDispatchPolicyState(cfg) === "enabled";
}

export function resolveAcpDispatchPolicyMessage(cfg: GenesisConfig): string | null {
...
export function resolveAcpDispatchPolicyError(cfg: GenesisConfig): AcpRuntimeError | null {
...
export function isAcpAgentAllowedByPolicy(cfg: GenesisConfig, agentId: string): boolean {
