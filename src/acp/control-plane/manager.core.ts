...
export class AcpSessionManager {
  ...
  resolveSession(params: { cfg: GenesisConfig; sessionKey: string }): AcpSessionResolution {
  ...
  getObservabilitySnapshot(cfg: GenesisConfig): AcpManagerObservabilitySnapshot {
  ...
  private resolveTurnTimeoutMs(params: { cfg: GenesisConfig; meta: SessionAcpMeta }): number {
  ...
  private enforceConcurrentSessionLimit(params: { cfg: GenesisConfig; sessionKey: string }): void {
  ...
  private async evictIdleRuntimeHandles(params: { cfg: GenesisConfig }): Promise<void> {
