...
describe("local media roots", () => {
  ...
  it.each([
    {
      ...
      stateDir: path.join("/tmp", "genesis-media-roots-state"),
    ...
    },
    {
      ...
      stateDir: path.join("/tmp", "genesis-agent-media-roots-state"),
  ...
  it.each([
    {
      ...
      stateDir: path.join("/tmp", "genesis-flexible-media-roots-state"),
      cfg: {},
    ...
    },
    {
      ...
      stateDir: path.join("/tmp", "genesis-messaging-media-roots-state"),
    ...
    },
    {
      ...
      stateDir: path.join("/tmp", "genesis-messaging-fs-media-roots-state"),
      cfg: {
        tools: {
          profile: "messaging",
  ...
  it("keeps the config-dir media cache root when state and config paths differ", () => {
    const stateDir = path.join("/tmp", "genesis-legacy-state");
    const configDir = path.join("/tmp", "genesis-current-config");
