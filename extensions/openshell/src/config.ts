...
import { buildPluginConfigSchema, type GenesisPluginConfigSchema } from "genesis/plugin-sdk/core";
import {
...
export function createOpenShellPluginConfigSchema(): GenesisPluginConfigSchema {
