...
import { buildPluginConfigSchema, z, type GenesisPluginConfigSchema } from "../api.js";
...
export const memoryWikiConfigSchema: GenesisPluginConfigSchema = memoryWikiConfigSchemaBase;
...
export function resolveDefaultMemoryWikiVaultPath(homedir = os.homedir()): string {
  return path.join(homedir, ".genesis", "wiki", "main");
}
