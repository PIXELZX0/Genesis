...
const GENERATED_START = "<!-- genesis:wiki:generated:start -->";
const GENERATED_END = "<!-- genesis:wiki:generated:end -->";
const HUMAN_START = "<!-- genesis:human:start -->";
const HUMAN_END = "<!-- genesis:human:end -->";
