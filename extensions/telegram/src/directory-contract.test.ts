import type { BaseProbeResult, BaseTokenResolution } from "genesis/plugin-sdk/channel-contract";
import { type GenesisConfig, withEnvAsync } from "genesis/plugin-sdk/testing";
