...
import { isDiagnosticFlagEnabled } from "genesis/plugin-sdk/diagnostic-runtime";
import { formatUncaughtError } from "genesis/plugin-sdk/error-runtime";
import { recordChannelActivity } from "genesis/plugin-sdk/infra-runtime";
import { createTelegramRetryRunner, type RetryConfig } from "genesis/plugin-sdk/retry-runtime";
...
import { normalizeOptionalString, redactSensitiveText } from "genesis/plugin-sdk/text-runtime";
...
function createTelegramHttpLogger(cfg: GenesisConfig) {
