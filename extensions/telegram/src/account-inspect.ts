import { resolveAccountWithDefaultFallback } from "genesis/plugin-sdk/account-core";
import { tryReadSecretFileSync } from "genesis/plugin-sdk/channel-core";
import type { GenesisConfig } from "genesis/plugin-sdk/config-runtime";
import { coerceSecretRef } from "genesis/plugin-sdk/config-runtime";
import type { TelegramAccountConfig } from "genesis/plugin-sdk/config-runtime";
import { resolveDefaultSecretProviderAlias } from "genesis/plugin-sdk/provider-auth";
import { DEFAULT_ACCOUNT_ID, normalizeAccountId } from "genesis/plugin-sdk/routing";
import {
...
function inspectTokenValue(params: { cfg: GenesisConfig; value: unknown }): {
  token: string;
