...
vi.mock("genesis/plugin-sdk/hook-runtime", async () => {
  const actual = await vi.importActual<typeof import("genesis/plugin-sdk/hook-runtime")>(
    "genesis/plugin-sdk/hook-runtime",
  );
  return {
    ...actual,
