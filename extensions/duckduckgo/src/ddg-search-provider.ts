import { readNumberParam, readStringParam } from "genesis/plugin-sdk/param-readers";
import type { WebSearchProviderPlugin } from "genesis/plugin-sdk/provider-web-search-contract";
