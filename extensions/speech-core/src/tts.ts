...
import { normalizeChannelId, type ChannelId } from "genesis/plugin-sdk/channel-targets";
import type {
  GenesisConfig,
  TtsAutoMode,
  TtsConfig,
...
import { isVerbose, logVerbose } from "genesis/plugin-sdk/runtime-env";
import { resolvePreferredGenesisTmpDir } from "genesis/plugin-sdk/sandbox";
import {
...
function sortSpeechProvidersForAutoSelection(cfg?: GenesisConfig) {
...
function _resolveRegistryDefaultSpeechProviderId(cfg?: GenesisConfig): TtsProvider {
...
function resolveEffectiveTtsAutoState(params: { cfg: GenesisConfig; sessionAuto?: string }): {
...
export function resolveTtsProviderOrder(primary: TtsProvider, cfg?: GenesisConfig): TtsProvider[] {
