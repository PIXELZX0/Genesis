...
vi.mock("genesis/plugin-sdk/routing", async () => {
  const actual = await vi.importActual<typeof import("genesis/plugin-sdk/routing")>(
    "genesis/plugin-sdk/routing",
  );
  return {
    ...actual,
...
vi.mock("genesis/plugin-sdk/agent-runtime", async () => {
  const actual = await vi.importActual<typeof import("genesis/plugin-sdk/agent-runtime")>(
    "genesis/plugin-sdk/agent-runtime",
  );
  return {
    ...actual,
