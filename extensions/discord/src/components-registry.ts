...
const DISCORD_COMPONENT_ENTRIES_KEY = Symbol.for("genesis.discord.componentEntries");
const DISCORD_MODAL_ENTRIES_KEY = Symbol.for("genesis.discord.modalEntries");
