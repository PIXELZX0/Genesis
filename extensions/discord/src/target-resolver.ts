import type { DirectoryConfigParams } from "genesis/plugin-sdk/directory-runtime";
import { buildMessagingTarget, type MessagingTarget } from "genesis/plugin-sdk/messaging-targets";
