...
import { listCombinedAccountIds } from "genesis/plugin-sdk/account-resolution";
...
export function listDiscordSetupAccountIds(cfg: GenesisConfig): string[] {
...
export function resolveDefaultDiscordSetupAccountId(cfg: GenesisConfig): string {
