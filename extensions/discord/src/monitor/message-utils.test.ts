...
vi.mock("genesis/plugin-sdk/media-runtime", async () => {
  const actual = await vi.importActual<typeof import("genesis/plugin-sdk/media-runtime")>(
    "genesis/plugin-sdk/media-runtime",
  );
  return {
    ...actual,
