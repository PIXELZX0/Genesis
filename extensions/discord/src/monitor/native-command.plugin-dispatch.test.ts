...
import type { NativeCommandSpec } from "genesis/plugin-sdk/command-auth";
...
import { dispatchReplyWithDispatcher } from "genesis/plugin-sdk/reply-dispatch-runtime";
...
function createConfig(): GenesisConfig {
  return {
    channels: {
      discord: {
...
async function createNativeCommand(cfg: GenesisConfig, commandSpec: NativeCommandSpec) {
...
async function createPluginCommand(params: { cfg: GenesisConfig; name: string }) {
  return createDiscordNativeCommand({
    command: {
      name: params.name,
      description: "Pair",
...
async function createStatusCommand(cfg: GenesisConfig) {
...
describe("Discord native plugin command dispatch", () => {
  ...
  beforeEach(() => {
    ...
    discordNativeCommandTesting.setMatchPluginCommand(
      runtimeModuleMocks.matchPluginCommand as typeof import("genesis/plugin-sdk/plugin-runtime").matchPluginCommand,
    );
    discordNativeCommandTesting.setExecutePluginCommand(
      runtimeModuleMocks.executePluginCommand as typeof import("genesis/plugin-sdk/plugin-runtime").executePluginCommand,
    );
