...
import type { SessionBindingRecord } from "genesis/plugin-sdk/conversation-runtime";
import type { HistoryEntry } from "genesis/plugin-sdk/reply-history";
import type { resolveAgentRoute } from "genesis/plugin-sdk/routing";
...
export type LoadedConfig = ReturnType<
  typeof import("genesis/plugin-sdk/config-runtime").loadConfig
>;
export type RuntimeEnv = import("genesis/plugin-sdk/runtime-env").RuntimeEnv;
...
type DiscordMessagePreflightSharedFields = {
  ...
  discordConfig: NonNullable<
    import("genesis/plugin-sdk/config-runtime").GenesisConfig["channels"]
  >["discord"];
  accountId: string;
  token: string;
  runtime: RuntimeEnv;
