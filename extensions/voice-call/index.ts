...
const voiceCallConfigSchema = {
  ...
  uiHints: {
    ...
    "realtime.toolPolicy": {
      ...
      help: "Controls the shared genesis_agent_consult tool.",
      advanced: true,
    },
...
const VOICE_CALL_RUNTIME_KEY = Symbol.for("genesis.voice-call.runtime");
const VOICE_CALL_RUNTIME_PROMISE_KEY = Symbol.for("genesis.voice-call.runtimePromise");
const VOICE_CALL_RUNTIME_STOP_PROMISE_KEY = Symbol.for("genesis.voice-call.runtimeStopPromise");
