...
import { resolveConfiguredCapabilityProvider } from "genesis/plugin-sdk/provider-selection-runtime";
...
export class VoiceCallWebhookServer {
  ...
  private fullConfig: GenesisConfig | null;
  ...
  private async initializeMediaStreaming(): Promise<void> {
    ...
    const pluginConfig =
      this.fullConfig ?? (this.coreConfig as unknown as GenesisConfig | undefined);
    ...
    const resolution = resolveConfiguredCapabilityProvider({
      ...
      cfg: pluginConfig,
      cfgForResolve: pluginConfig ?? ({} as GenesisConfig),
