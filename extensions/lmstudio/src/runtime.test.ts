...
vi.mock("genesis/plugin-sdk/provider-auth-runtime", async (importOriginal) => {
  const actual = await importOriginal<typeof import("genesis/plugin-sdk/provider-auth-runtime")>();
  return {
    ...actual,
