...
vi.mock("genesis/plugin-sdk/msteams", () => ({
...
vi.mock("genesis/plugin-sdk/text-runtime", async (importOriginal) => {
  const actual = await importOriginal<typeof import("genesis/plugin-sdk/text-runtime")>();
  return {
    ...actual,
