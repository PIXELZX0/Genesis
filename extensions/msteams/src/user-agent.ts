...
function resolveGenesisVersion(): string {
  try {
 ...
 * and appends the Genesis version.
 *
 * Format: "teams.ts[apps]/<sdk-version> Genesis/<genesis-version>"
 * Example: "teams.ts[apps]/2.0.5 Genesis/2026.3.22"
 *
