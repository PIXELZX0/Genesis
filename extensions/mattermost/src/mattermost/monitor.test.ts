import { createClaimableDedupe } from "genesis/plugin-sdk/persistent-dedupe";
...
function evaluateMentionGateForMessage(params: { cfg: GenesisConfig; threadRootId?: string }) {
