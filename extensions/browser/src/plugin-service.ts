import {
  ...
  type GenesisPluginService,
} from "genesis/plugin-sdk/browser-node-runtime";
...
export function createBrowserPluginService(): GenesisPluginService {
  ...
  return {
    ...
    start: async () => {
      ...
      handle = await startLazyPluginServiceModule({
        skipEnvVar: "GENESIS_SKIP_BROWSER_CONTROL_SERVER",
        overrideEnvVar: "GENESIS_BROWSER_CONTROL_MODULE",
