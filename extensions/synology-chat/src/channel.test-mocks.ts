...
vi.mock("genesis/plugin-sdk/setup", async () => {
  const actual = await vi.importActual<object>("genesis/plugin-sdk/setup");
  return {
    ...actual,
...
vi.mock("genesis/plugin-sdk/channel-config-schema", async () => {
  const actual = await vi.importActual<object>("genesis/plugin-sdk/channel-config-schema");
  return {
    ...actual,
...
vi.mock("genesis/plugin-sdk/webhook-ingress", async () => {
  const actual = await vi.importActual<object>("genesis/plugin-sdk/webhook-ingress");
  return {
    ...actual,
