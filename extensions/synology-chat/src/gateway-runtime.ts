import { DEFAULT_ACCOUNT_ID, type GenesisConfig } from "genesis/plugin-sdk/account-resolution";
import { registerPluginHttpRoute } from "genesis/plugin-sdk/webhook-ingress";
