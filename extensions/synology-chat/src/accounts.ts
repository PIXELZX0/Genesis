...
import { resolveDangerousNameMatchingEnabled } from "genesis/plugin-sdk/dangerous-name-runtime";
import type {
...
function getChannelConfig(cfg: GenesisConfig): SynologyChatChannelConfig | undefined {
