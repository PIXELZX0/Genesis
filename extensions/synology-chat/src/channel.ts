...
import { waitUntilAbort } from "genesis/plugin-sdk/channel-lifecycle";
import {
...
import { attachChannelToResult } from "genesis/plugin-sdk/channel-send-result";
import { createEmptyChannelDirectoryAdapter } from "genesis/plugin-sdk/directory-runtime";
...
> & {
  pairing: {
    ...
    notifyApproval: (params: { cfg: GenesisConfig; id: string }) => Promise<void>;
  };
  security: {
    resolveDmPolicy: (params: { cfg: GenesisConfig; account: ResolvedSynologyChatAccount }) => {
