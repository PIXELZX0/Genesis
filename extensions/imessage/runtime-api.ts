import type { GenesisConfig as RuntimeApiGenesisConfig } from "genesis/plugin-sdk/config-runtime";
...
export type IMessageAccountConfig = Omit<
  NonNullable<NonNullable<RuntimeApiGenesisConfig["channels"]>["imessage"]>,
