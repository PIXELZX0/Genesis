...
export function applyArceeProviderConfig(cfg: GenesisConfig): GenesisConfig {
  return arceePresetAppliers.applyProviderConfig(cfg);
}

export function applyArceeConfig(cfg: GenesisConfig): GenesisConfig {
  return arceePresetAppliers.applyConfig(cfg);
}

export function applyArceeOpenRouterConfig(cfg: GenesisConfig): GenesisConfig {
