...
import { patchTopLevelChannelConfigSection } from "genesis/plugin-sdk/setup";
import {
...
function getNostrConfig(cfg: GenesisConfig): NostrAccountConfig | undefined {
  return (cfg.channels as Record<string, unknown> | undefined)?.nostr as
    | NostrAccountConfig
    | undefined;
}

function listSetupNostrAccountIds(cfg: GenesisConfig): string[] {
...
function resolveDefaultSetupNostrAccountId(cfg: GenesisConfig): string {
