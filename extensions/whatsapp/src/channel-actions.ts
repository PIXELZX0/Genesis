...
function areWhatsAppAgentReactionsEnabled(params: { cfg: GenesisConfig; accountId?: string }) {
...
function hasAnyWhatsAppAccountWithAgentReactionsEnabled(cfg: GenesisConfig) {
