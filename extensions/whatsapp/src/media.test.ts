...
import { captureEnv } from "genesis/plugin-sdk/testing";
import { mockPinnedHostnameResolution } from "genesis/plugin-sdk/testing";
import { optimizeImageToPng } from "genesis/plugin-sdk/web-media";
...
beforeAll(async () => {
  fixtureRoot = await fs.mkdtemp(path.join(resolvePreferredGenesisTmpDir(), "genesis-media-test-"));
