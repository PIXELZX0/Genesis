...
const providerFilter = parseCsvFilter(process.env.GENESIS_LIVE_MUSIC_GENERATION_PROVIDERS);
const envModelMap = parseProviderModelMap(process.env.GENESIS_LIVE_MUSIC_GENERATION_MODELS);
