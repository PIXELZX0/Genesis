import { resolvePluginConfigObject } from "genesis/plugin-sdk/config-runtime";
import { createSubsystemLogger } from "genesis/plugin-sdk/core";
...
const LIVE_DISCOVERY_ENV = "GENESIS_CODEX_DISCOVERY_LIVE";
