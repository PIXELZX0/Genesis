...
import type { WizardPrompter } from "genesis/plugin-sdk/matrix-runtime-shared";
...
import { isPrivateNetworkOptInEnabled } from "genesis/plugin-sdk/ssrf-policy";
import {
...
async function configureMatrixInviteAutoJoin(params: {
  ...
  await params.prompter.note(
    [
      ...
      "Genesis agents will not join invited rooms or fresh DM-style invites unless you set autoJoin.",
