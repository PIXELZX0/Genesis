...
import { hasConfiguredSecretInput } from "genesis/plugin-sdk/secret-input-runtime";
...
export function resolveMatrixChannelConfig(cfg: GenesisConfig): Record<string, unknown> | null {
