import type { OutputRuntimeEnv } from "genesis/plugin-sdk/runtime";
import type { ChannelSetupWizardAdapter } from "genesis/plugin-sdk/setup";
...
export function createMatrixUpdateKeepCredentialsPrompter(params?: {
  ...
  return createMatrixWizardPrompter({
    ...
    text: {
      ...
      "Matrix device name (optional)": params?.deviceName ?? "Genesis Gateway",
    },
    confirm: {
