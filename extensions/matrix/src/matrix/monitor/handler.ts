...
} from "genesis/plugin-sdk/session-store-runtime";
...
import { MATRIX_GENESIS_FINALIZED_PREVIEW_KEY } from "../send/types.js";
...
let acpBindingRuntimePromise:
  | Promise<typeof import("genesis/plugin-sdk/acp-binding-runtime")>
  | undefined;
let sessionBindingRuntimePromise:
  | Promise<typeof import("genesis/plugin-sdk/session-binding-runtime")>
  | undefined;
...
function loadAcpBindingRuntime(): Promise<typeof import("genesis/plugin-sdk/acp-binding-runtime")> {
  acpBindingRuntimePromise ??= import("genesis/plugin-sdk/acp-binding-runtime");
  return acpBindingRuntimePromise;
}

function loadSessionBindingRuntime(): Promise<
  typeof import("genesis/plugin-sdk/session-binding-runtime")
> {
  sessionBindingRuntimePromise ??= import("genesis/plugin-sdk/session-binding-runtime");
...
function buildMatrixFinalizedPreviewContent(): Record<string, unknown> {
  return { [MATRIX_GENESIS_FINALIZED_PREVIEW_KEY]: true };
}
