import { resolveConfiguredAcpBindingRecord } from "genesis/plugin-sdk/acp-binding-resolve-runtime";
...
import { getSessionBindingService } from "genesis/plugin-sdk/session-binding-runtime";
