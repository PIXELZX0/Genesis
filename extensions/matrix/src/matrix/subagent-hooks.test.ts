import type { GenesisPluginApi as MatrixEntryPluginApi } from "genesis/plugin-sdk/channel-entry-contract";
...
vi.mock("genesis/plugin-sdk/conversation-binding-runtime", () => ({
