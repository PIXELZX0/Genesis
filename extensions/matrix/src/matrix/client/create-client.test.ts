...
describe("createMatrixClient", () => {
  const storagePaths = {
    rootDir: "/tmp/genesis-matrix-create-client-test",
    storagePath: "/tmp/genesis-matrix-create-client-test/storage.json",
    recoveryKeyPath: "/tmp/genesis-matrix-create-client-test/recovery.key",
    idbSnapshotPath: "/tmp/genesis-matrix-create-client-test/idb.snapshot",
    metaPath: "/tmp/genesis-matrix-create-client-test/storage-meta.json",
    accountKey: "default",
  ...
  it("persists storage metadata by default", async () => {
    ...
    expect(MatrixClientMock).toHaveBeenCalledWith("https://matrix.example.org", "tok", {
      ...
      cryptoDatabasePrefix: "genesis-matrix-default-token-hash",
