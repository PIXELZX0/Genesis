...
function resolveGoogleChatAccountImpl(params: { cfg: GenesisConfig; accountId?: string | null }) {
...
vi.mock("./channel.deps.runtime.js", () => {
  return {
    ...
    listGoogleChatAccountIds: (cfg: GenesisConfig) => {
...
function createGoogleChatCfg(): GenesisConfig {
  return {
    channels: {
      googlechat: {
        enabled: true,
