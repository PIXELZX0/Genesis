...
import { MINIMAX_FAST_MODE_STREAM_HOOKS } from "genesis/plugin-sdk/provider-stream-family";
import { fetchMinimaxUsage } from "genesis/plugin-sdk/provider-usage";
...
export function registerMinimaxProviders(api: GenesisPluginApi) {
