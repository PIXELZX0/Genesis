...
export function resolveLegacyXSearchConfig(config?: GenesisConfig): JsonRecord | undefined {
...
export function resolvePluginXSearchConfig(config?: GenesisConfig): JsonRecord | undefined {
...
export function resolveEffectiveXSearchConfig(config?: GenesisConfig): JsonRecord | undefined {
