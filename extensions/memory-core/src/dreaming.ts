import { peekSystemEventEntries } from "genesis/plugin-sdk/infra-runtime";
...
const LEGACY_LIGHT_SLEEP_EVENT_TEXT = "__genesis_memory_core_light_sleep__";
const LEGACY_REM_SLEEP_CRON_NAME = "Memory REM Dreaming";
const LEGACY_REM_SLEEP_CRON_TAG = "[managed-by=memory-core.dreaming.rem]";
const LEGACY_REM_SLEEP_EVENT_TEXT = "__genesis_memory_core_rem_sleep__";
...
export function registerShortTermPromotionDreaming(api: GenesisPluginApi): void {
  ...
  const resolveCurrentConfig = (): GenesisConfig =>
