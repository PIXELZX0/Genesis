...
import { resolveUserPath } from "genesis/plugin-sdk/memory-core-host-engine-foundation";
import { getProviderEnvVars } from "genesis/plugin-sdk/provider-env-vars";
...
function formatLocalSetupError(err: unknown): string {
  ...
  return [
    ...
    missing
      ? `2) Install optional local embedding runtime next to Genesis: npm i -g ${NODE_LLAMA_CPP_INSTALL_SPEC}`
      : null,
