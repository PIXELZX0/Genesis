...
describe("memory watcher config", () => {
  ...
  function createWatcherConfig(overrides?: Partial<MemorySearchConfig>): GenesisConfig {
    const defaults: NonNullable<NonNullable<GenesisConfig["agents"]>["defaults"]> = {
  ...
  async function expectWatcherManager(cfg: GenesisConfig) {
