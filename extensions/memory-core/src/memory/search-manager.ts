...
import {
  ...
  type GenesisConfig,
} from "genesis/plugin-sdk/memory-core-host-engine-foundation";
import { checkQmdBinaryAvailability } from "genesis/plugin-sdk/memory-core-host-engine-qmd";
import {
...
import { normalizeAgentId } from "genesis/plugin-sdk/routing";

const MEMORY_SEARCH_MANAGER_CACHE_KEY = Symbol.for("genesis.memorySearchManagerCache");
type Maybe<T> = T | null;
