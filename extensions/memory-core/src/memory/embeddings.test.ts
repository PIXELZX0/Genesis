import type { MemoryEmbeddingProviderAdapter } from "genesis/plugin-sdk/memory-core-host-engine-embeddings";
...
vi.mock("genesis/plugin-sdk/memory-core-host-engine-embeddings", () => ({
