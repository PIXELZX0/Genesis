import type { ChannelSetupAdapter, GenesisConfig } from "genesis/plugin-sdk/setup";
import { createSetupInputPresenceValidator } from "genesis/plugin-sdk/setup";
...
export function isLineConfigured(cfg: GenesisConfig, accountId: string): boolean {
