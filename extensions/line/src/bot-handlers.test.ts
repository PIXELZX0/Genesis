...
vi.mock("genesis/plugin-sdk/channel-inbound", () => ({
  buildMentionRegexes: () => [],
...
vi.mock("genesis/plugin-sdk/channel-pairing", () => ({
...
vi.mock("genesis/plugin-sdk/command-auth", () => ({
...
vi.mock("genesis/plugin-sdk/config-runtime", () => ({
...
vi.mock("genesis/plugin-sdk/group-access", () => ({
