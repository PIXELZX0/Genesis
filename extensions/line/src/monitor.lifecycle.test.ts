...
import { WEBHOOK_IN_FLIGHT_DEFAULTS } from "genesis/plugin-sdk/webhook-request-guards";
...
vi.mock("genesis/plugin-sdk/reply-runtime", () => ({
...
vi.mock("genesis/plugin-sdk/webhook-ingress", () => ({
