import { formatInboundEnvelope } from "genesis/plugin-sdk/channel-inbound";
import type { ContextVisibilityMode } from "genesis/plugin-sdk/config-runtime";
...
export async function resolveSlackThreadContextData(params: {
  ...
  envelopeOptions: ReturnType<
    typeof import("genesis/plugin-sdk/channel-inbound").resolveEnvelopeFormatOptions
  >;
