...
import type { DmPolicy, GroupPolicy } from "genesis/plugin-sdk/config-runtime";
import { formatErrorMessage } from "genesis/plugin-sdk/error-runtime";
import { createDedupeCache } from "genesis/plugin-sdk/infra-runtime";
...
export type SlackMonitorContext = {
  ...
  slashCommand: Required<import("genesis/plugin-sdk/config-runtime").SlackSlashCommandConfig>;
  textLimit: number;
