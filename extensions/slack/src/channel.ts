...
} from "genesis/plugin-sdk/allowlist-config-edit";
import { adaptScopedAccountAccessor } from "genesis/plugin-sdk/channel-config-helpers";
import {
...
//
// `genesis/plugin-sdk/channel-policy` is intentionally NOT lazy here —
...
const EXTENSION_SHARED_MODULE_ID = "genesis/plugin-sdk/extension-shared";
const TARGET_RESOLVER_RUNTIME_MODULE_ID = "genesis/plugin-sdk/target-resolver-runtime";
  ...
  base: {
    ...
    actions: createSlackActions(SLACK_CHANNEL, {
      invoke: async (action, cfg, toolContext) =>
        ...
        )(action, cfg as GenesisConfig, toolContext as SlackActionContext | undefined),
    }),
