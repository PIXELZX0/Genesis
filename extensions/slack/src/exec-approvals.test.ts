...
function buildConfig(
  execApprovals?: NonNullable<NonNullable<GenesisConfig["channels"]>["slack"]>["execApprovals"],
  channelOverrides?: Partial<NonNullable<NonNullable<GenesisConfig["channels"]>["slack"]>>,
): GenesisConfig {
  return {
    channels: {
      slack: {
