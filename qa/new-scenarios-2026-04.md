...
- Code: `.agents/skills/genesis-qa-testing/SKILL.md`, `docs/gateway/protocol.md`
...
- Code: `src/agents/genesis-tools.image-generation.test.ts`, `src/image-generation/runtime.ts`
