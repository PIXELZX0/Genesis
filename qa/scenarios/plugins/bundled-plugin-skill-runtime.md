...
successCriteria:
  - The runtime-packaged bundled plugin tree is used as GENESIS_BUNDLED_PLUGINS_DIR.
          ...
          expr: |-
            (async () => {
              ...
              const cliEnv = {
                ...
                GENESIS_OAUTH_DIR: path.join(stateDir, "credentials"),
                GENESIS_BUNDLED_PLUGINS_DIR: distRuntimeExtensions,
