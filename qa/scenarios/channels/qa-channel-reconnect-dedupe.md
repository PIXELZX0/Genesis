...
execution:
  ...
  config:
    firstPrompt: "@genesis Reconnect dedupe setup marker. Reply exactly: RECONNECT-FIRST-OK"
    secondPrompt: "@genesis Reconnect dedupe follow-up marker. Reply exactly: RECONNECT-SECOND-OK"
