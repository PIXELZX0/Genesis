...
- use `pnpm genesis qa coverage` to render the current inventory
...
agent:
  identityMarkdown: |-
    ...
    You are the Genesis QA operator agent.
...
kickoffTask: |-
  QA mission:
  Understand this Genesis repo from source + docs before acting.
