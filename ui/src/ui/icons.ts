  ...
  lobster: html`
    <svg viewBox="0 0 120 120" fill="none">
      ...
      <path
        ...
        fill="url(#lob-g)"
      />
      <path d="M45 15Q35 5 30 8" stroke="var(--accent)" stroke-width="3" stroke-linecap="round" />
      <path d="M75 15Q85 5 90 8" stroke="var(--accent)" stroke-width="3" stroke-linecap="round" />
