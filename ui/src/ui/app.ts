...
import {
  ...
  handleChannelDelete as handleChannelDeleteInternal,
...
export class GenesisApp extends LitElement {
  ...
  @state() theme: ThemeName = this.settings.theme ?? "mono";
  ...
  @state() channelDeletingKey: string | null = null;
  ...
  @state() mcpAuthToken = "";
  @state() mcpPresetId: string | null = null;
  @state() mcpLinkUrl = "";
  ...
  @state() walletTokenDialog: import("./controllers/wallet.js").WalletTokenDialog | null = null;
  ...
  async handleChannelDelete(channel: string, accountId?: string | null): Promise<boolean> {
    return await handleChannelDeleteInternal(this, channel, accountId);
  }
