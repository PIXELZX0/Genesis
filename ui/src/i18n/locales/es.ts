...
export const es: TranslationMap = {
  ...
  subtitles: {
    ...
    mcp: "Manage Model Context Protocol servers for this Gateway.",
    plugins: "Install and manage Gateway plugins.",
    models: "Model catalog and providers.",
    files: "Browse and edit files on the gateway host.",
    memory: "Agentic memory store.",
    contact: "People remembered across messengers.",
    ...
    config: "Editar ~/.genesis/genesis.json de forma segura.",
  ...
  contactsView: {
    empty: "No contacts remembered yet.",
    noAgent: "No agent selected. Open an agent to view its contacts.",
    colName: "Name",
    colMessengers: "Messengers",
    colAge: "Age",
    colUpdated: "Updated",
  },
  modelsView: {
    ...
    addModelSub: "Register a custom model under a provider.",
    addProviderTitle: "Add provider",
    addProviderSub: "Store an API key so the provider's models become available.",
    fieldProvider: "Provider",
    fieldModelId: "Model ID",
    fieldDisplayName: "Display name",
    fieldDisplayNameHint: "Optional",
  ...
  agentsView: {
    ...
    createSub: "Create an agent and assign a model.",
    fieldName: "Name",
  ...
  mcpView: {
    ...
    add: {
      ...
      link: {
        ...
        save: "Save server",
        cancel: "Cancel",
        unsupportedTitle: "No metadata found",
        unsupportedHint:
          "We could not detect a remote MCP server at that URL. Switch to the JSON tab to add it manually.",
      ...
      json: {
        ...
        configHint:
          "Use url + transport for remote (HTTP/SSE) servers, or command + args for local stdio servers.",
        save: "Save server",
        saveAs: "Save as new",
    ...
    list: {
      ...
      emptyHint: "Use the form above to add a server.",
      ...
      testing: "Testing…",
      test: "Test",
      testOk: "Server responded.",
      testFailed: "Server did not respond.",
      transportHttp: "HTTP",
      transportStdio: "stdio",
    },
    oauth: {
      title: "Connect to {name}",
      subtitle: "Genesis will open the authorization page in a new tab.",
      ...
      manualHint: "Paste the access token your provider gave you.",
    },
  },
  canvasView: {
    workspaceTitle: "Document workspace",
    workspaceSubtitle: "Create, upload, update, and reopen hosted Canvas documents.",
    recentTitle: "Recent documents",
    recentSubtitle: "Latest hosted Canvas manifests.",
    ...
    status: {
      ...
      host: "Host",
      sandbox: "Sandbox",
      externalEmbeds: "External embeds",
      loading: "Loading documents…",
      noDocuments: "No hosted documents yet.",
      noPreview: "No preview loaded.",
      saving: "Saving Canvas document…",
      saved: "Saved {id}.",
      selected: "Selected {id}.",
    },
    errors: {
      notConnected: "Connect to the gateway first.",
      sourceRequired: "Choose a source before saving.",
      fileRequired: "Choose a file to upload.",
      idRequired: "Document ID is required for updates.",
      untrustedUrl:
        "Only trusted Canvas URLs under /__genesis__/canvas or /__genesis__/a2ui can be embedded here.",
    },
  },
  overview: {
    access: {
    ...
    pairing: {
      ...
      mobileHint:
        "¿En el móvil? Copia la URL completa (incluyendo #token=...) desde genesis dashboard --no-open en tu escritorio.",
    ...
    cards: {
      ...
      modelAuthAttentionExpiredDesc: "{providers} — vuelve a autenticarte con genesis models auth",
  ...
  wallet: {
    title: "Wallet",
    subtitle: "Local wallet addresses, balances, and safety state.",
    ...
    accounts: {
      title: "Accounts",
      subtitle: "Public wallet accounts from the gateway.",
      emptyMissing: "No wallet keystore found.",
      emptyNoAccounts: "Wallet keystore exists, but no public accounts were found.",
    ...
    tokens: {
      title: "Tokens",
      subtitle: "Configured EVM token balances from the gateway.",
    ...
    nfts: {
      title: "NFTs",
      subtitle: "Configured EVM NFT collections and tracked token IDs.",
      balance: "Collection balance",
      tokens: "Tokens",
      empty: "No configured EVM NFT holdings found.",
      refreshHint: "Refresh balances to load configured EVM NFT holdings.",
      noTrackedTokens: "No tracked token IDs owned or configured",
      copyContract: "Copy NFT contract",
    },
    recoveryPhrase: {
      title: "Secret Recovery Phrase",
      subtitle: "Create or import one phrase that derives every local chain account.",
      safety:
        "The gateway encrypts the phrase locally. Existing phrases are never revealed; a generated phrase is shown once so you can back it up.",
      mode: "Recovery phrase mode",
      generate: "Generate",
      import: "Import",
      phraseLabel: "Secret recovery phrase",
      ...
      generatedTitle: "Generated phrase, shown once",
      copyGenerated: "Copy generated phrase",
