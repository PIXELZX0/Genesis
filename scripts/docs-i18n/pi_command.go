...
const (
	envDocsPiExecutable     = "GENESIS_DOCS_I18N_PI_EXECUTABLE"
	envDocsPiArgs           = "GENESIS_DOCS_I18N_PI_ARGS"
	envDocsPiPackageVersion = "GENESIS_DOCS_I18N_PI_PACKAGE_VERSION"
	envDocsPiOmitProvider   = "GENESIS_DOCS_I18N_PI_OMIT_PROVIDER"
...
func getMaterializedPiRuntimeDir() (string, error) {
	...
	return filepath.Join(cacheDir, "genesis", "docs-i18n", "pi-runtime", getMaterializedPiPackageVersion()), nil
}
