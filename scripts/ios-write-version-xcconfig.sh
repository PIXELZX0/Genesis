...
- GENESIS_IOS_VERSION = exact canonical iOS version
- GENESIS_MARKETING_VERSION = short iOS/App Store version
- GENESIS_BUILD_VERSION = explicit build number or local numeric fallback
EOF
}
...
GENESIS_IOS_VERSION = ${IOS_VERSION}
GENESIS_MARKETING_VERSION = ${MARKETING_VERSION}
GENESIS_BUILD_VERSION = ${BUILD_NUMBER}
EOF
