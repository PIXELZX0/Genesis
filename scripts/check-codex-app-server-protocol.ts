...
const codexRepo = process.env.GENESIS_CODEX_REPO
  ? path.resolve(process.env.GENESIS_CODEX_REPO)
...
console.log(
  `Codex app-server generated protocol matches Genesis bridge assumptions: ${schemaRoot}`,
);
