...
CDP_PORT="${GENESIS_BROWSER_CDP_PORT:-9222}"
CDP_SOURCE_RANGE="${GENESIS_BROWSER_CDP_SOURCE_RANGE:-}"
VNC_PORT="${GENESIS_BROWSER_VNC_PORT:-5900}"
NOVNC_PORT="${GENESIS_BROWSER_NOVNC_PORT:-6080}"
ENABLE_NOVNC="${GENESIS_BROWSER_ENABLE_NOVNC:-1}"
HEADLESS="${GENESIS_BROWSER_HEADLESS:-0}"
ALLOW_NO_SANDBOX="${GENESIS_BROWSER_NO_SANDBOX:-0}"
NOVNC_PASSWORD="${GENESIS_BROWSER_NOVNC_PASSWORD:-}"

DISABLE_GRAPHICS_FLAGS="${GENESIS_BROWSER_DISABLE_GRAPHICS_FLAGS:-1}"
DISABLE_EXTENSIONS="${GENESIS_BROWSER_DISABLE_EXTENSIONS:-1}"
RENDERER_PROCESS_LIMIT="${GENESIS_BROWSER_RENDERER_PROCESS_LIMIT:-2}"
AUTO_START_TIMEOUT_MS="${GENESIS_BROWSER_AUTO_START_TIMEOUT_MS:-12000}"
...
if [[ -z "${CDP_SOURCE_RANGE}" ]]; then
  ...
  echo "[sandbox-browser] Set GENESIS_BROWSER_CDP_SOURCE_RANGE to an explicit CIDR to enable CDP access." >&2
else
