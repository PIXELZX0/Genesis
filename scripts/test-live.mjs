...
const env = {
  ...process.env,
  GENESIS_LIVE_TEST: process.env.GENESIS_LIVE_TEST || "1",
  GENESIS_LIVE_TEST_QUIET: quietOverride ?? process.env.GENESIS_LIVE_TEST_QUIET ?? "1",
};
...
const heartbeatMs = parsePositiveInt(process.env.GENESIS_LIVE_WRAPPER_HEARTBEAT_MS, 20_000);
