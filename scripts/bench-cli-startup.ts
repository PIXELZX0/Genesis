...
const DEFAULT_ENTRY = "genesis.mjs";
...
function printUsage(): void {
  console.log(`Genesis CLI benchmark
...
Options:
  ...
  --entry <path>               Primary entry file (default: genesis.mjs)
...
async function main(): Promise<void> {
  ...
  const tmpDir = mkdtempSync(path.join(os.tmpdir(), "genesis-cli-bench-"));
