...
export const OPTIONAL_BUNDLED_BUILD_ENV = "GENESIS_INCLUDE_OPTIONAL_BUNDLED";
...
export function hasReleasedBundledInstall(packageJson) {
  return (
    typeof packageJson?.genesis?.install?.npmSpec === "string" &&
    packageJson.genesis.install.npmSpec.trim().length > 0
  );
}
