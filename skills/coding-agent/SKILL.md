...
8. **NEVER start Codex inside your Genesis state directory** (`$GENESIS_STATE_DIR`, default `~/.genesis`) - it'll read your soul docs and get weird ideas about the org chart!
