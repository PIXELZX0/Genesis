---
summary: "Use SOUL.md to give your Genesis agent an actual voice instead of generic assistant sludge"
read_when:
...
Genesis injects it on normal sessions, so it has real weight. If your agent
...
For Genesis, `SOUL.md` is that layer.
...
Path fixed for Genesis workspaces: use `SOUL.md`, not `http://SOUL.md`.
