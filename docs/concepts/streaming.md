...
media block early, Genesis remembers that delivery for the turn. If the final
...
distinct text around media that was already streamed, Genesis still sends the
