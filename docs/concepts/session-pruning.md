...
Genesis also runs a separate idempotent cleanup for older legacy sessions that
...
Genesis auto-enables pruning for Anthropic profiles:
...
If you set explicit values, Genesis does not override them.
