...
- You can still use the CLI flow in [Gateway health](/gateway/health) (`genesis status`, `genesis status --deep`, `genesis health --json`) and tail `/tmp/genesis/genesis-*.log` for `web-heartbeat` / `web-reconnect`.
