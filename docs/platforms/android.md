...
> **Note:** The Android app has not been publicly released yet. The source code is available in the [Genesis repository](https://github.com/PIXELZX0/Genesis) under `apps/android`. You can build it yourself using Java 17 and the Android SDK (`./gradlew :app:assemblePlayDebug`). See [apps/android/README.md](https://github.com/PIXELZX0/Genesis/blob/main/apps/android/README.md) for build instructions.
...
Android supports launching Genesis from the system assistant trigger (Google
Assistant). When configured, holding the home button or saying "Hey Google, ask
Genesis..." opens the app and hands the prompt into the chat composer.
...
and whether the user has set Genesis as the default assistant app.
</Note>
