...
Zalo ships as a bundled plugin in current Genesis releases, so normal packaged
...
- Or from a source checkout: `genesis plugins install ./path/to/local/zalo-plugin`
...
This page reflects current Genesis behavior for **Zalo Bot Creator / Marketplace bots**.
...
This table summarizes current **Zalo Bot Creator / Marketplace bot** behavior in Genesis.
