---
summary: "Synthetic Slack-class channel plugin for deterministic Genesis QA scenarios"
title: "QA channel"
read_when:
...
`qa-channel` is a bundled synthetic message transport for automated Genesis QA.
...
- Genesis-native orchestration later
