---
summary: "Use xAI Grok models in Genesis"
read_when:
  - You want to use Grok models in Genesis
...
<Note>
Genesis uses the xAI Responses API as the bundled xAI transport. The same
...
The bundled plugin maps xAI's current public API surface onto Genesis's shared
...
<Note>
Genesis uses xAI's REST image/video/TTS/STT APIs for media generation,
...
code-execution tools. Features that need different Genesis contracts, such as
...
shared image live file verifies the same xAI provider through Genesis's
