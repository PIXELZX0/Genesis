...
<Steps>
  ...
  <Step title="Verify setup">
    ```bash
    genesis agent --model venice/kimi-k2-5 --message "Hello, are you working?"
    ```
  </Step>
</Steps>
...
```bash
genesis models set venice/kimi-k2-5
genesis models set venice/claude-opus-4-6
```
...
You can also run `genesis configure`, select **Model/auth**, and choose **Venice AI**.
...
genesis agent --model venice/kimi-k2-5 --message "Quick health check"

# Use Claude Opus via Venice (anonymized)
genesis agent --model venice/claude-opus-4-6 --message "Summarize this task"
