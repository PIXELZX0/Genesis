...
CLI onboarding is the **recommended** way to set up Genesis on macOS,
...
`genesis configure --section web`. Docs: [Web tools](/tools/web).
</Tip>
...
4. **Channels** — built-in and bundled chat channels such as BlueBubbles, Discord, Feishu, Google Chat, Mattermost, Microsoft Teams, Signal, Slack, Telegram, WhatsApp, and more.
...
If the config is invalid or contains legacy keys, onboarding asks you to run `genesis doctor` first.
</Note>
