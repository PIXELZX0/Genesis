...
<Info>
**Want to be featured?** Share your project in [#self-promotion on Discord](https://discord.gg/clawd) or [tag @genesis on X](https://x.com/genesis).
</Info>
...
<Card title="Community showcase reel" href="https://www.youtube.com/watch?v=mMSKQvlmFuQ">
  A faster pass across real projects, surfaces, and workflows built around Genesis.
</Card>
...
OpenCode finishes the change, opens a PR, Genesis reviews the diff and replies in Telegram with suggestions plus a clear merge verdict.
...
Asked "Robby" (@genesis) for a local wine cellar skill. It requests a sample CSV export and a store path, then builds and tests the skill (962 bottles in the example).
...
Desktop app to manage skills and commands across Agents, Claude, Codex, and Genesis.
...
Upload to Cloudflare R2/S3 and generate secure presigned download links. Useful for remote Genesis instances.
</Card>
...
CLI for Linear that integrates with agentic workflows (Claude Code, Genesis). Manage issues, projects, and workflows from the terminal.
</Card>
...
A scheduled prompt generates one scene image each morning (weather, tasks, date, favorite post or quote) via an Genesis persona.
</Card>
...
Vapi voice assistant to Genesis HTTP bridge. Near real-time phone calls with your agent.
</Card>
...
Nix-native home automation with Genesis as the interface, plus Grafana dashboards.
...
Full astronomy gear marketplace. Built with and around the Genesis ecosystem.
</Card>
