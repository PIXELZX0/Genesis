---
summary: "Genesis threat model mapped to the MITRE ATLAS framework"
...
This is a living document maintained by the Genesis community. See [CONTRIBUTING-THREAT-MODEL.md](/security/CONTRIBUTING-THREAT-MODEL) for guidelines on contributing:
