---
summary: "How to contribute to the Genesis threat model"
...
> **This is for adding to the threat model, not reporting live vulnerabilities.** If you've found an exploitable vulnerability, see our [Trust page](https://trust.genesis.pixelzx.com) for responsible disclosure instructions.
...
- [Genesis Threat Model](/security/THREAT-MODEL-ATLAS)

## Contact

- **Security vulnerabilities:** See our [Trust page](https://trust.genesis.pixelzx.com) for reporting instructions
