---
summary: "Genesis tools and plugins overview: what the agent can do and how to extend it"
read_when:
  - You want to understand what tools Genesis provides
...
<Steps>
  ...
  <Step title="Plugins package everything together">
    ...
    Genesis), others are **external** (published on npm by the community).
...
These tools ship with Genesis and are available without installing any plugins:
...
Genesis fails closed when an explicit allowlist resolves to no callable tools.
