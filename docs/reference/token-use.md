...
available; otherwise Genesis falls back to matching OAuth/API-key credentials
...
Genesis skips the `context-1m-*` beta header because Anthropic currently
