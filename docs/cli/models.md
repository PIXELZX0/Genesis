...
when available; otherwise Genesis falls back to matching OAuth/API-key
...
- If you omit the provider, Genesis resolves the input as an alias first, then
...
- `no_model`: provider auth exists, but Genesis could not resolve a probeable
