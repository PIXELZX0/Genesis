...
Configure Gmail watch, Pub/Sub, and Genesis webhook delivery.
...
```bash
genesis webhooks gmail setup --account you@example.com
genesis webhooks gmail setup --account you@example.com --project my-gcp-project --json
genesis webhooks gmail setup --account you@example.com --hook-url https://gateway.example.com/hooks/gmail
```
...
```bash
genesis webhooks gmail run --account you@example.com
```
