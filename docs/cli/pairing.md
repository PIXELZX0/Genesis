---
summary: "CLI reference for `genesis pairing` (approve/list pairing requests)"
read_when:
...
genesis pairing list --channel telegram --account work
genesis pairing list telegram --json

genesis pairing approve <code>
genesis pairing approve telegram <code>
genesis pairing approve --channel telegram --account work <code> --notify
```
...
- `genesis pairing approve --channel <channel> <code>`
- `genesis pairing approve <code>` when exactly one pairing-capable channel is configured
