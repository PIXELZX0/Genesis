...
import ai.genesis.app.ui.mobileAccentBorderStrong
...
import ai.genesis.app.ui.mobileSurface
import ai.genesis.app.ui.mobileText
import ai.genesis.app.ui.mobileTextSecondary
import ai.genesis.app.ui.mobileTextTertiary
  ...
  Column(modifier = Modifier.fillMaxWidth(), verticalArrangement = Arrangement.spacedBy(8.dp)) {
    ...
    if (!healthOk) {
      Text(
        ...
        style = mobileCallout,
        color = ai.genesis.app.ui.mobileWarning,
      )
    }
...
private fun mobileBodyStyle() =
  MaterialTheme.typography.bodyMedium.copy(
    fontFamily = ai.genesis.app.ui.mobileFontFamily,
