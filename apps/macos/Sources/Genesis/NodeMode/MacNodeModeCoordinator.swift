...
final class MacNodeModeCoordinator {
    ...
    private func run() async {
        ...
        while !Task.isCancelled {
            ...
            let browserControlEnabled = GenesisConfigFile.browserControlEnabled()
    ...
    private func currentCaps() -> [String] {
        ...
        if GenesisConfigFile.browserControlEnabled() {
            caps.append(GenesisCapability.browser.rawValue)
        }
    ...
    private func currentCommands(caps: [String]) -> [String] {
        ...
        if capsSet.contains(GenesisCapability.browser.rawValue) {
            commands.append(GenesisBrowserCommand.proxy.rawValue)
        }
