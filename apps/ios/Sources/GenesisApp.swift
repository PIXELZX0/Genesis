...
final class GenesisAppDelegate: NSObject, UIApplicationDelegate, @preconcurrency UNUserNotificationCenterDelegate {
    ...
    private func resolvedAppModel() -> NodeAppModel? {
        self.appModel ?? GenesisAppModelRegistry.appModel
    }
...
enum WatchPromptNotificationBridge {
    ...
    static let actionIdentifierPrefix = "genesis.watch.action."
    static let actionIDKeyPrefix = "genesis.watch.action.id."
    static let actionLabelKeyPrefix = "genesis.watch.action.label."
    ...
    private static func categoryActions(_ actions: [GenesisWatchAction]) -> [UNNotificationAction] {
...
struct GenesisApp: App {
    ...
    init() {
        ...
        GenesisAppModelRegistry.appModel = appModel
