...
final class LiveActivityManager {
    ...
    private let logger = Logger(subsystem: "ai.genesis.ios", category: "LiveActivity")
    private var currentActivity: Activity<GenesisActivityAttributes>?
    ...
    func startActivity(agentName: String, sessionKey: String) {
        ...
        let attributes = GenesisActivityAttributes(agentName: agentName, sessionKey: sessionKey)
    ...
    private func hydrateCurrentAndPruneDuplicates() {
        let active = Activity<GenesisActivityAttributes>.activities
    ...
    private func updateCurrent(state: GenesisActivityAttributes.ContentState) {
    ...
    private func connectingState() -> GenesisActivityAttributes.ContentState {
        GenesisActivityAttributes.ContentState(
    ...
    private func idleState() -> GenesisActivityAttributes.ContentState {
        GenesisActivityAttributes.ContentState(
            statusText: "Idle",
            isIdle: true,
            isDisconnected: false,
    ...
    private func disconnectedState() -> GenesisActivityAttributes.ContentState {
        GenesisActivityAttributes.ContentState(
