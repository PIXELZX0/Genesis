...
public enum GatewayDeviceAuthPayload {
    ...
    public static func signedDeviceDictionary(
        ...
        signedAtMs: Int,
        nonce: String) -> [String: GenesisProtocol.AnyCodable]?
    {
        ...
        return [
            "id": GenesisProtocol.AnyCodable(identity.deviceId),
            "publicKey": GenesisProtocol.AnyCodable(publicKey),
            "signature": GenesisProtocol.AnyCodable(signature),
            "signedAt": GenesisProtocol.AnyCodable(signedAtMs),
            "nonce": GenesisProtocol.AnyCodable(nonce),
        ]
    }
}
