...
public struct GenesisChatView: View {
    ...
    private func shouldDisplayMessage(_ message: GenesisChatMessage) -> Bool {
    ...
    private func primaryText(in message: GenesisChatMessage) -> String {
    ...
    private func hasInlineAttachments(in message: GenesisChatMessage) -> Bool {
    ...
    private func toolCalls(in message: GenesisChatMessage) -> [GenesisChatMessageContent] {
    ...
    private func inlineToolResults(in message: GenesisChatMessage) -> [GenesisChatMessageContent] {
        message.content.filter { content in
            let kind = (content.type ?? "").lowercased()
