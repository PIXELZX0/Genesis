---
name: genesis-test-performance
description: Benchmark, diagnose, and optimize Genesis test runtime, import hotspots, CPU/RSS, and slow coverage paths.
---

# Genesis Test Performance
...
2. Establish a baseline before changing code:
   ...
   - For import-heavy suspicion add:
     `GENESIS_VITEST_IMPORT_DURATIONS=1 GENESIS_VITEST_PRINT_IMPORT_BREAKDOWN=1`.
...
timeout 240 /usr/bin/time -l env \
  GENESIS_VITEST_IMPORT_DURATIONS=1 \
  GENESIS_VITEST_PRINT_IMPORT_BREAKDOWN=1 \
