---
name: genesis-secret-scanning-maintainer
description: Triage, redact, clean up, and resolve Genesis GitHub Secret Scanning alerts in issues or PRs.
---

# Genesis Secret Scanning Maintainer
...
Use this skill when processing alerts from `https://github.com/genesis/genesis/security/secret-scanning`.
...
```
$REPO_ROOT/.agents/skills/genesis-secret-scanning-maintainer/scripts/secret-scanning.mjs
```
...
[
  {
    ...
    "location_url": "https://github.com/genesis/genesis/issues/63101#issuecomment-xxx",
