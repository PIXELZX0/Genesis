...
export function installGenesisOwnedToolHooks(params?: {
 ...
 * Pair with `installGenesisOwnedToolHooks()` when a test asserts before/after hook behavior.
 */
...
export function resetGenesisOwnedToolHooks(): void {
  resetGlobalHookRunner();
  resetPluginRuntimeStateForTest();
