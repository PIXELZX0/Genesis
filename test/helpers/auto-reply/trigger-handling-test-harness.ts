...
const piEmbeddedMocks = getSharedMocks("genesis.trigger-handling.pi-embedded-mocks", () => ({
...
const modelCatalogMocks = getSharedMocks("genesis.trigger-handling.model-catalog-mocks", () => ({
...
const modelFallbackMocks = getSharedMocks("genesis.trigger-handling.model-fallback-mocks", () => ({
...
const webSessionMocks = getSharedMocks("genesis.trigger-handling.web-session-mocks", () => ({
